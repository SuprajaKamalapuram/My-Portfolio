        ...
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
           ...
           <div className='md:w-1/2 mb-10 md:mb-0'>
            <h1 className='text-3xl md:text-5xl font-bold mb-4'> 
                Hi, I'm <span className='text-purple'>Supraja Kamalapuram</span>
            </h1>
            <h2 className='text-2xl md:text-4xl font-semibold mb-6 typewriter'>MERN Stack Developer</h2>
            <p className='text-lg text-gray-300 mb-8'>I create stunning web experiences with modern technologies.</p>
